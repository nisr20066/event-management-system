  ...
  <div class="home">
    ...
    <section class="featured">
      ...
      <div class="section-header">
        ...
        <button class="view-all" @click="goToEvents">
          View All Events →
        </button>
...
// Get image for every event
function getEventImage(event) {

  // First use image from API
  if (event.image_url) {
    return event.image_url
  }

  // If API image is null, use same image as Events page
...
// If any image fails, show generic event image
